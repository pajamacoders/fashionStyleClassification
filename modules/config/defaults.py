...
# Model Related
_C.MODEL = CN()
_C.MODEL.TYPE='ArcStyleClassification'
...
# HEAD Related
_C.HEAD = CN()
_C.HEAD.in_features=512
_C.HEAD.out_features=3
_C.HEAD.s=10.0
_C.HEAD.m=0.50
_C.HEAD.easy_margin=False
...
# SOLVER
_C.SOLVER = CN()
_C.SOLVER.TYPE = 'CosineAnnealingLR'
_C.SOLVER.EVAL_STEPS = 5
